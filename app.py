...
if (_HERE / "engine.py").is_file():
    ...
    from stockevents import (  # type: ignore  # noqa: E402
        default_sample_path,
    ...
    from stock_buy_sell.stockevents import (  # noqa: E402
        default_sample_path,
        get_last_import_source,
        positions_to_dataframe,
    )
...
def main() -> None:
    ...
    st.caption(
        "Import broker / StockEvents CSVs · evaluate each ticker against the "
    ...
    with st.sidebar:
        ...
        uploaded = st.file_uploader(
            ...
            type=["csv"],
            help=(
                "StockEvents or major brokers (Fidelity, Schwab, IBKR, Robinhood, "
                "E*TRADE, Webull, Moomoo, TD/ToS, Vanguard, or generic Symbol/Date/Qty/Price). "
                "Format is auto-detected. Equity trades only — options are skipped."
            ),
        )
    ...
    if uploaded is not None:
        ...
        st.info("Upload a StockEvents CSV in the sidebar to get started.")
        st.stop()
